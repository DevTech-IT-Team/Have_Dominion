      ...
      <div className="max-w-4xl mx-auto bg-midnight-800/80 backdrop-blur-sm rounded-xl shadow-2xl p-8 md:p-10 border border-electric/20">
        ...
        <div className="prose max-w-none">
          <div className="space-y-8">
            ...
            <section>
              <h3 className="text-xl font-semibold text-electric mb-3 border-b border-electric/20 pb-2">1. Acceptance of Terms</h3>
              <p className="text-gray-300 leading-relaxed">
            ...
            <section>
              <h3 className="text-xl font-semibold text-electric mb-3 border-b border-electric/20 pb-2">2. Services Provided</h3>
              <p className="text-gray-300 leading-relaxed">
            ...
            <section>
              <h3 className="text-xl font-semibold text-electric mb-3 border-b border-electric/20 pb-2">3. Appointments & Scheduling</h3>
              <p className="text-gray-300 leading-relaxed">
            ...
            <section>
              <h3 className="text-xl font-semibold text-electric mb-3 border-b border-electric/20 pb-2">4. Payments & Billing</h3>
              <p className="text-gray-300 leading-relaxed">
            ...
            <section>
              <h3 className="text-xl font-semibold text-electric mb-3 border-b border-electric/20 pb-2">5. Cancellations & Refunds</h3>
              <p className="text-gray-300 leading-relaxed">
            ...
            <section>
              <h3 className="text-xl font-semibold text-electric mb-3 border-b border-electric/20 pb-2">6. Liability & Damages</h3>
              <p className="text-gray-300 leading-relaxed">
            ...
            <section>
              <h3 className="text-xl font-semibold text-electric mb-3 border-b border-electric/20 pb-2">7. Use of Website</h3>
              <p className="text-gray-300 leading-relaxed">
            ...
            <section>
              <h3 className="text-xl font-semibold text-electric mb-3 border-b border-electric/20 pb-2">8. Changes to Terms</h3>
              <p className="text-gray-300 leading-relaxed">
            ...
            <section>
              <h3 className="text-xl font-semibold text-electric mb-3 border-b border-electric/20 pb-2">Contact Us</h3>
              <p className="text-gray-300 leading-relaxed">
