  ...
  */
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-gradient-to-b from-blue-50/50 via-white to-white">
                ...
                <div className="overflow-hidden rounded-2xl w-full h-80 bg-gradient-to-br from-blue-100 to-amber-50 relative shadow-lg">
                  ...
                  <div className="absolute bottom-6 left-6 right-6">
                    <div className="text-white text-left">
                      ...
                      <div className="text-sm opacity-90">Professional Mastery & Financial Independence</div>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section id="services" className="py-16 bg-gradient-to-b from-blue-50 to-white">
      ...
      {/* Golden Services Section - Commented Out
            ...
            {[
              ...
              <div key={index} className="text-center group">
                <div className="relative inline-flex items-center justify-center mb-6">
                  <div className={`absolute inset-0 ${step.theme === 'blue' ? 'bg-blue-400' : 'bg-amber-400'
                    } rounded-full blur-lg opacity-30 group-hover:opacity-50 transition-opacity`}></div>
                  <div className={`relative bg-white border-2 ${step.theme === 'blue' ? 'border-blue-400' : 'border-amber-400'
                    } rounded-full w-20 h-20 flex items-center justify-center group-hover:scale-110 transition-all duration-300 shadow-md`}>
                    <div className={`${step.theme === 'blue' ? 'text-blue-600 group-hover:text-blue-700' : 'text-amber-600 group-hover:text-amber-700'
                      } transition-colors`}>
                      {step.icon}
                    </div>
                  </div>
                  <div className={`absolute -top-2 -right-2 ${step.theme === 'blue' ? 'bg-blue-500' : 'bg-amber-500'
                    } text-white rounded-full w-8 h-8 flex items-center justify-center text-sm font-bold shadow-sm`}>
                    {step.step}
                  </div>
                </div>
                <h3 className="text-xl font-semibold text-gray-900 mb-3">{step.title}</h3>
                <p className={`text-sm ${step.theme === 'blue' ? 'text-blue-700' : 'text-amber-700'
                  }`}>{step.description}</p>
              </div>
            ))}
          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            {documentFeatures.map((feature, index) => (
              <div key={index} className={`bg-white rounded-2xl p-6 border-2 ${feature.color === 'blue' ? 'border-blue-200 hover:border-blue-300' : 'border-amber-200 hover:border-amber-300'
                } text-center transition-all duration-500 hover:-translate-y-2 shadow-md hover:shadow-xl hover:shadow-${feature.color === 'blue' ? 'blue' : 'amber'
                }-100`}>
                <div className={`inline-flex p-3 rounded-xl mb-4 ${feature.color === 'blue' ? 'bg-blue-100 text-blue-600' : 'bg-amber-100 text-amber-600'
                  }`}>
                  {feature.icon}
                </div>
                <h3 className="text-lg font-semibold text-gray-900 mb-3">{feature.title}</h3>
                <p className={`text-sm ${feature.color === 'blue' ? 'text-blue-800' : 'text-amber-800'
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {creditorAcademy.map((level, index) => (
              <div
                key={index}
                className={`rounded-2xl p-8 bg-gradient-to-br ${level.gradient} border-2 ${level.theme === "blue"
                    ? "border-blue-300"
                    : "border-amber-300"
              ...
              >
                ...
                <button
                  ...
                  className={`w-full bg-white font-semibold py-3 rounded-xl mt-6 transition-all duration-300 hover:scale-105 shadow-md ${level.theme === "blue"
